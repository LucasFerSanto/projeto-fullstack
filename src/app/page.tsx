...
import {Plus, List, Check, CircleEllipsis, SquarePen, Trash, ListCheck, Sigma } from 'lucide-react';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
    ...
    <main className="w-full h-screen bg-gray-100 flex justify-center items-center">
      <Card className="w-lg">
        ...
        <CardContent>
          ...
          <Badge className="cursor-pointer" variant="outline"><CircleEllipsis />Não Finalizadas</Badge>
        ...
        <div className="flex justify-between mt-4">
          ...
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button className="text-xs h-7 cursor-pointer" variant="outline"><Trash/>Limpar tarefas
              concluídas</Button>
            </AlertDialogTrigger>
            <AlertDialogContent>
              <AlertDialogHeader>
